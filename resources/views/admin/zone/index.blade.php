      ...
      <div class="page-title">
          <div class="row">
              <div class="col-12 col-sm-6">
                  <h3 style="color: #1e2f65;font-family: sans-serif;">Zone List</h3>
              </div>
              <div class="col-12 col-sm-6">
                  <ol class="breadcrumb">
                  ...
                  <div class="card-body">
                      <div class="d-flex justify-content-between align-items-center mb-4">
                          ...
                          <button class="btn btn-primary">
                              <a href="{{ route('zone.create') }}" style="color: white;">
                          ...
                          <table class="display" id="data-source-1" style="width:100%">
                              <thead>
                                  <tr>
                                      ...
                                      <th>Zone(English)</th>
                                      <th>Zone(Kannada)</th>
                                      <th>Corporation(English)</th>
                                      <th>Corporation(Kannada)</th>
                                      <th>Status</th>
                                      <th>Actions</th>
                                  </tr>
                              </thead>
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                          <a class="btn btn-sm btn-info me-2" title="View"
                                              href="{{ route('zone.show', $entry->id) }}">
                                              <i class="bi bi-eye"></i>
                                          </a>
                                          <a class="btn btn-sm btn-primary me-2" title="Edit"
                                              href="{{ route('zone.edit', $entry->id) }}">
