      ...
      <div class="page-title">
          <div class="row">
              <div class="col-12 col-sm-6">
                  <h3 style="color: #1e2f65;font-family: sans-serif;">Corporation List</h3>
              </div>
              <div class="col-12 col-sm-6">
                  <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active">Corporation List</li>
                  </ol>
              </div>
          </div>
      </div>
                  ...
                  <div class="card-body">
                      <div class="d-flex justify-content-between align-items-center mb-4">
                          ...
                          <button class="btn btn-primary">
                              <a href="{{ route('corporation.create') }}" style="color: white;">
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                          <a class="btn btn-sm btn-info me-2" title="View"
                                              href="{{ route('corporation.show', $entry->id) }}">
                                              <i class="bi bi-eye"></i>
                                          </a>
                                          <a class="btn btn-sm btn-primary me-2" title="Edit"
                                              href="{{ route('corporation.edit', $entry->id) }}">
