          ...
          <div class="row">
              ...
              <div class="col-12 col-sm-6">
                  <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active">Edit Corporation</li>
                  </ol>
              </div>
          </div>
      </div>
      ...
      <div class="row">
          <div class="col-sm-12">
              <div class="card">
                  ...
                  <div class="card-body">
                        <form id="CorporationForm" action="{{ route('corporation.update', $corporation->id) }}" method="post">
                          @csrf @method('put')
                              <!-- Select Screen -->
                              <div class="mb-3">
                              ...
                              <div class="mb-3">
                                  ...
                                  <input
                                      ...
                                      placeholder="Enter Corporation Name in Kannada"
                                        name="name_kn" value="{{$corporation->name_kn}}"
                                      required
                                  >
                              </div>
                              <!-- Submit -->
