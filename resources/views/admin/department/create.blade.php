      ...
      <div class="row">
          <div class="col-sm-12">
              <div class="card">
                  ...
                  <div class="card-body">
                      <form id="DesignationForm" action="{{ route('department.store') }}" method="post">
                        @csrf
                        <!-- Select Screen -->
                        <div class="mb-3">
                            <label class="form-label fw-bold">Department Name<span style="color:red;">*</span></label>
                            <input type="text" class="form-control"
                                placeholder="Enter Department Name" name="name" required>
                        </div>
