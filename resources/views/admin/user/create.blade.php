      ...
      <div class="row">
          <div class="col-sm-12">
              <div class="card">
                  ...
                  <div class="card-body">
                      <form id="UsersForm" action="{{ route('user.store') }}" method="post">
                        @csrf
                          <div class="mb-3">
                              <label class="form-label fw-bold">Users Name (English)</label>
                              <input type="text" class="form-control"
                                  placeholder="Enter Users Name in English" name="name" required>
                          </div>

                          <div class="mb-3">
                              <label class="form-label fw-bold">Users Name (Kannada)</label>
                              <input type="text" class="form-control"
                                  placeholder="Enter Users Name in Kannada" name="name_kn" required>
                          </div>
