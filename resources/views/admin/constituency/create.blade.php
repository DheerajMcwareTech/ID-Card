      ...
      <div class="row">
          <div class="col-sm-12">
              <div class="card">
                  ...
                  <div class="card-body">
                      <form id="wardForm" action="{{ route('constituency.store') }}" method="post">
                          @csrf
                          <div class="row g-4">
                              ...
                              <div class="col-md-6">
                                  ...
                                  <div class="mb-3">
                                      ...
                                      <input type="text" class="form-control"
                                          placeholder="Enter Constituency Name in English" name="name" required>
                                  </div>
                              ...
                              <div class="col-md-6">
                                  ...
                                  <div class="mb-3">
                                      ...
                                      <input type="text" class="form-control"
                                          placeholder="Enter Constituency Name in Kannada" name="name_kn" required>
                                  </div>
