    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-sm-6">
                <h3 style="color: #1e2f65;font-family: sans-serif;">Designation List</h3>
            </div>
            <div class="col-12 col-sm-6">
                <ol class="breadcrumb">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <button class="btn btn-primary">
                            <a href="{{ route('designation.create') }}" style="color: white;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-info me-2" title="View"
                                            onclick="window.location=`{{ route('designation.show', $entry->id) }}`">
                                            <i class="bi bi-eye"></i>
                                        </button>
                                        <button class="btn btn-sm btn-primary me-2" title="Edit"
                                            onclick="window.location=`{{ route('designation.edit', $entry->id) }}`">
